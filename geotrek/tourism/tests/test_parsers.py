...
class ParserTests(TranslationResetMixin, TestCase):
    ...
    def test_create_content_apidae(self, mocked):
        ...
        self.assertTrue(u"<br><b>Capacité totale:</b><br>10<br>" in content.practical_info_fr)
    ...
    def test_create_event_apidae(self, mocked):
        ...
        self.assertEqual(event.name_fr, u"Cols Réservés 2019 : Montée de Chabre (Laragne)")
        self.assertEqual(event.name, u"Nom EN")
        self.assertEqual(event.name_en, u"Nom EN")
        self.assertEqual(event.description_en, u"Descriptif Detaillé EN")
        self.assertEqual(event.description, u"Descriptif Detaillé EN")
        self.assertEqual(event.description_fr[:31], u"Le département des Hautes-Alpes")
        self.assertEqual(event.description_teaser_fr[:18], u"Une des ascensions")
        self.assertEqual(event.description_teaser_en, u"Descriptif Court EN")
        self.assertEqual(event.description_teaser, u"Descriptif Court EN")
        ...
        self.assertIn(u"<b>Openning:</b><br>Tuesday, August 6, 2019 from 9am to noon.<br>", event.practical_info_en)
        self.assertIn(u"<b>Ouverture:</b><br>Mardi 6 août 2019 de 9h à midi.<br>", event.practical_info_fr)
        self.assertIn(u"<b>Spoken languages:</b><br>French<br><br>", event.practical_info_en)
        self.assertIn(u"<b>Spoken languages:</b><br>French<br><br>", event.practical_info)
        self.assertIn(u"<b>Langues Parlées:</b><br>Français<br>", event.practical_info_fr)
